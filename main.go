...
func main() {
	...
	containersFile := flag.String("containers", "containers.txt", "Container names file (default: containers.txt)")
	dirPrefixesFile := flag.String("dirprefixes", "dirprefixes.txt", "Directory prefix name files")
